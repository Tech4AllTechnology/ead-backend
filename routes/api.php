...
Route::group(['middleware' => 'auth:api'], function() {
    ...
    Route::get('/user/{user}/program', 'UserController@listPrograms');
    ...
    Route::get('/program/{program}/courses', 'ProgramController@listCourses');

    Route::get('/course', 'CourseController@index');
    Route::post('/course', 'CourseController@store');
    Route::put('/course/{course}', 'CourseController@update');
    Route::delete('/course/{course}', 'CourseController@destroy');
    Route::get('/course/{course}/program', 'CourseController@listPrograms');
