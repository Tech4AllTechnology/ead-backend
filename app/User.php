...
class User extends Authenticatable implements HasRoleAndPermissionContract
{
    ...
    protected $fillable = [
        ...
        'scholarship_conclusion_date', 'city', 'state_id', 'neighborhood', 'number', 'street', 'cep', 'university_campus_id'
    ];
    ...
    public function getUsersList() {
        return User::whereNull('deleted_at')
            ->with('telephones:id,user_id,telephone_number')
            ->with('programs:id,name,code')
